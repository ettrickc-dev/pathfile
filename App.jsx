  ...
  return (
    <section className="pf-card">
      ...
      <p className="pf-finefee">
        Fees are paid to USCIS, not to Easy Immigration Filing. As of October 2025, USCIS no longer accepts checks
    ...
    <section className="pf-card pf-pay">
      ...
      <div className="pf-receipt">
        ...
        <div className="pf-receipt-fine">
          This is Easy Immigration Filing's preparation fee only. Government filing fees are paid separately to USCIS
