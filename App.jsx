  ...
  const pay = async () => {
    ...
    try {
      const res = await fetch("/.netlify/functions/checkout", {
        ...
        body: JSON.stringify({ clientData, result, data, email: email.trim() }),
      });
    ...
    <section className="pf-card pf-pay">
      ...
      <div className="pf-receipt">
        ...
        <ul className="pf-getlist pf-getlist-pay">
          ...
          <li>A copy emailed to you, plus link to re-download anytime</li>
        </ul>
      </div>
      ...
      <label className="pf-agree">
        ...
        <span>I understand PathFile is a self-help document-preparation service, not a law firm, and does not provide legal advice. I agree to the Terms of Service, Privacy Policy, and Refund Policy (linked at the bottom of the page).</span>
      </label>
