...
export const MAILING = {
  familyConcurrent: {
    ...
    verify: "Confirm your state's exact lockbox on the USCIS Lockbox Filing Locations Chart for family-based forms before mailing — it takes a minute and makes sure it arrives at the right place.",
...
export const HANDWRITE = {
  "N-400": [
    "Part 4 (Where You Have Lived): your current address is filled in. Add any other places you've lived in the last 5 years, with move-in and move-out dates.",
    "Part 6 & Part 7 (Time Outside the U.S. and Employment/Schools): your most recent details are filled in. Add the rest of the last 5 years — list each trip (dates you left and returned) and each employer or school with its address and dates.",
    "Part 5 (Marital History): if you were married before, add each prior spouse and how that marriage ended.",
    "Part 8 / Part 14 (Additional Information): use these pages for anything that didn't fit in the boxes above — just note the Part and item number you're continuing.",
    "Your children: list each child's full name, date of birth, and A-Number (if they have one).",
  ],
  "I-130": [
