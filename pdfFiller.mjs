...
function buildMaps(d) {
  ...
  C(d.s_taxes_owe==="Yes"?"P9_Line3[0]":"P9_Line3[1]",6); C(d.s_taxes_nonresident==="Yes"?"P9_Line4[0]":"P9_Line4[1]",6);
  ...
  const N400 = [
    ...
    ["Line2_FamilyName1[0]",1,g("s_other_last")],["Line3_GivenName1[0]",1,g("s_other_first")],["Line3_MiddleName1[0]",1,g("s_other_middle")],
    ...
    ["Part9Line3_TimesMarried[0]",4,g("s_times_married")],
    ...(nm==="Married" ? [
